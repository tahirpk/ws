...
function PersistentFolderOpening()
{
  ...
  var id
  var nodeObj
 // stateInCookie = GetCookie("clickedFolder");    //BY ALi -------------------------------------------->>>>>>>>>>>>>>>>
...
var BASEPATH = 'http://suleman/newintown'
var url
var USETEXTLINKS = 0;
var STARTALLOPEN = 0;
var USEFRAMES = 1;
...
var PRESERVESTATE = 0;
var ICONPATH = BASEPATH+'/application_data/common/js/images/';
var HIGHLIGHT = 0;
...
function initializeDocument(mName) 
{ 
  preLoadIcons();
