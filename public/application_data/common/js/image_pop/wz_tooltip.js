...
{
	var sCss = 'position:relative;margin:0px;padding:0px;left:0px;top:0px;line-height:normal;width:auto;',
	...
	tt_aElt[0].innerHTML =
		...
		+ (tt_aV[TITLE].length ?
			...
			+ '</tr></tbody></table></div>')
			: '')
		+ '<div id="WzBoDy" style="position:relative;z-index:-1;">'
		+ '<table' + sTbTrTd + 'id="WzBoDyI" style="' + sCss + '">'
		+ tt_sContent
		+ '</td></tr></tbody></table></div>'
		+ (tt_aV[SHADOW]
			? ('<div id="WzTtShDwR" style="position:relative;overflow:hidden;"></div>'
